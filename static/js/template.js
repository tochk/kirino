...
$("#addNew").click(function () {
    $("#cancel").css("display", "inline-block"), $("#sbm").attr("disabled", "disabled"), macAddrs = $("input.mac_valid"), $(".input_forms").append(`
        <div class='item'>
            ...
            <div class='form-group'>
                ...
                <div class='col-md-10'>
                    <input type='mac' name='mac` + i + `' onchange=if(CheckMACAddress(this.value)==false){$(this).parent().parent().addClass('has-error1');$(this).parent().parent().removeClass('has-success');}else{$(this).parent().parent().addClass('has-success');$(this).parent().parent().removeClass('has-error1');} class='form-control mac_valid mac'  placeholder='Mac' required><span class='help-block'>Введите Mac адрес в формате XX:XX:XX:XX:XX:XX, где ХХ - цифры или латинские буквы от A до F</span>
                </div>
            </div>                                                                                                                       
            <div class='form-group'>
                <label for='inputName' class='col-md-2 control-label'>Ф.И.О.</label> 
                <div class='col-md-10'>
                    <input type='name' name='user` + i + `' class='form-control name' id='inputPassword' placeholder='Ф.И.О' required>
                </div>
            </div>
        </div>`), console.log("added"), $("input.mac, input.name").focusin(function () {
        $(this).parent().parent().removeClass("has-error1")
    });
    var b = "#ttl" + i;
    return  $("input.mac").focusout(function () {
    ...
    }), $("input.mac, input.name").keyup(function () {
        var a = !0, b = !0, c = !0;
        $("input.mac").each(function () {
...
}), $("input.mac, input.name").focusin(function () {
    $(this).parent().parent().removeClass("has-error1")
    ...
    "" == $("input.name").val() || 0 == CheckMACAddress($("input.mac").val()) ? $("#sbm").attr("disabled", "disabled") : $("#sbm").removeAttr("disabled")
}), jQuery(document).ready(function () {
    function a(a) {
